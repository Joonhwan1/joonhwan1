...
#------토큰 숨기기---------
import os
token = os.getenv['OTg0NjU1NTAzMzIzOTYzNDcz.GLI8jG.yZbwBr8oWr06M4Ehmbc_73prf6pA8vDngomFEs']
#------------------------------
...
bot.run('OTg0NjU1NTAzMzIzOTYzNDcz.GLI8jG.yZbwBr8oWr06M4Ehmbc_73prf6pA8vDngomFEs')
